...
admin.site.register([Cliente, Endereco, Categoria, Produto, Carro, CarroProduto, PedidoOrder, PedidoProduto, Banner, Empresa, Admin, AdminLog, LogPesquisa, TestStatus])
